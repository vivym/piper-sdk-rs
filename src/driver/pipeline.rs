...
use crate::driver::metrics::PiperMetrics;
...
///
/// ```
/// use piper_sdk::driver::PipelineConfig;
///
...
///
/// ```
/// # use piper_sdk::driver::pipeline::ParserState;
...
pub fn tx_loop_mailbox(
    ...
    realtime_slot: Arc<std::sync::Mutex<Option<crate::driver::command::RealtimeCommand>>>,
