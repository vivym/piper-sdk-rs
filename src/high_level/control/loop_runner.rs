...
//!
//! ```rust,ignore
//! use piper_sdk::high_level::control::{run_controller, LoopConfig, Controller};
...
use crate::high_level::client::{MotionCommander, Observer};
...
///
/// ```rust,ignore
/// use piper_sdk::high_level::control::{run_controller, LoopConfig};
/// # use piper_sdk::high_level::client::{Observer, MotionCommander};
/// # use piper_sdk::high_level::control::Controller;
/// # fn example(
/// #     observer: Observer,
