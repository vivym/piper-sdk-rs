...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let torques_partial = gravity_calc.compute_partial_inverse_dynamics(&q_horizontal, &qvel)?;
    ...
    let torques_full = gravity_calc.compute_inverse_dynamics(&q_horizontal, &qvel_fast, &qacc)?;
